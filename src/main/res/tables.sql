...
BEGIN
  IF :new.issue_id IS NULL THEN
    select bt_issues_ids_seq.nextval into :new.issue_id from dual;
  END IF;
END;
/
...
BEGIN
  IF :new.reply_id IS NULL THEN
      select bt_replies_ids_seq.nextval into :new.reply_id from dual;
  END IF;
END;
/
...
BEGIN
  IF :new.project_id IS NULL THEN
      select bt_projects_ids_seq.nextval into :new.project_id from dual;
  END IF;
END;
/
...
BEGIN
  IF :new.user_id IS NULL THEN
      select bt_users_ids_seq.nextval into :new.user_id from dual;
  END IF;
END;
/
...
BEGIN
  IF :new.status_id IS NULL THEN
      select bt_issue_statuses_ids_seq.nextval into :new.status_id from dual;
  END IF;
END;
/